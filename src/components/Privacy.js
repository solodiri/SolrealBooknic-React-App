...
<main className="privacy">
        ...
        <p>Personally Identifiable Information collected by [URL] is securely stored and is not accessible to third parties or employees of [URL] except for use as indicated above.
        ...
        <p>[URL] uses login information, including, but not limited to, IP addresses, ISPs, and browser types, to analyze trends, administer the Site, track a user's movement and use, and gather broad demographic information.
